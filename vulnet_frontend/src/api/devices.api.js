...
export const getAverageSustainability = () => devicesApi.get(`/averagesustainability/`);

export const getDeviceSustainability = (device) => devicesApi.get(`/devicesustainability/${device}`);
