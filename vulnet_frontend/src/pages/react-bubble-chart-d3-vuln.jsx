...
export default class BubbleChart extends Component {
  ...
  renderBubbles(width, nodes, color) {
    ...
    .enter().append("g")
      ...
      .on("click", function(d) {
        bubbleClickFun(d.srcElement.__data__.data.label);
    });
  ...
  renderLegend(width, height, offset, nodes, color) {
    ...
    .append("g")
      ...
      .on("click", function(d) {
        legendClickFun(d.srcElement.__data__.data.label);
    });;
...
BubbleChart.defaultProps = {
  ...
  bubbleClickFun: (label) => {window.location.href = (window.location.origin+"/"+window.location.pathname.split("/")[1]+"/"+window.location.pathname.split("/")[2]+"/"+label);},
  legendClickFun: (label) => {window.location.href = (window.location.origin+"/"+window.location.pathname.split("/")[1]+"/"+window.location.pathname.split("/")[2]+"/"+label);}
}
